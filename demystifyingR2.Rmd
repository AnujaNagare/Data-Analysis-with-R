    ...
    ```{r}
#   efficient <- subset(mtcars, mtcars$mpg > 23 | mtcars$mpg == 23)
    ...
    ```{r}
    efficient <- subset(mtcars, mtcars$mpg > 23)
    paste(nrow(efficient), "cars get more than 23 mpg")
    ...
    ```{r}
    cars1 <- subset(mtcars, qsec < 16.90 | qsec == 16.90)
    cars1    
    ```
    ...
    paste("Number of Light Cars:", nrow(lightCars))
    print(lightCars)
    ...
    ```{r}
    cars30_60 <- subset(mtcars, mpg >= 30 | hp <60)
    cars30_60
